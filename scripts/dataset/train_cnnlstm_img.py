...
parser.add_argument('--dataset_name', type=str, default="kitti-test-imgae-cnn-lstm-01", help='name of the dataset')
...
parser.add_argument('--test_interval', type=int, default=20, help='interval between model test')
...
model = CNNLSTM(hidden_dim=256, input_dim=3).to(device)
model.load_state_dict(torch.load('result/saved_models/kitti-train-imgae-cnn-lstm-01/model_4000.pth'))
