...
from learning.robo_dataset_utils.robo_utils.kitti.torch_dataset import TrajectoryDataset2
...
parser.add_argument('--dataset_name', type=str, default="kitti-muti-sample-01", help='name of the dataset')
parser.add_argument('--width', type=int, default=400, help='image width')
parser.add_argument('--height', type=int, default=200, help='image height')
parser.add_argument('--scale', type=float, default=30., help='longitudinal length')
parser.add_argument('--batch_size', type=int, default=8, help='size of the batches')
parser.add_argument('--traj_steps', type=int, default=4, help='traj steps')
...
def eval_error(total_step):
    ...
    for i in range(100):
        ...
        batch['img'] = batch['img'].view(-1,10,1,200,400)
